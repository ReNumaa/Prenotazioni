...
// Definiti qui (ui.js) perché tenant.js li usa prima che data.js sia caricato.
...
function _lsSet(key, value) {
    try {
        ...
        if (e instanceof DOMException && (e.name === 'QuotaExceededError' || e.code === 22)) {
            console.error('[localStorage] QuotaExceededError:', key);
            if (typeof showToast === 'function') showToast('Memoria locale piena.', 'error', 8000);
        }
        return false;
    }
}
